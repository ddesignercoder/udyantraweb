...
<head>
    ...
    <title>Udyantra Psychometric Report | Sample Career Analysis</title>
        ...
        @foreach($outcomes as $index => $outcome)
            <div style="border: 1px solid #ddd;margin-top: 50px ;padding: 15px; border-radius: 8px; font-size: 14px; page-break-before: always;">
                ...
                <div class="rec-block" style="margin-bottom: 8px;">
                    <span class="rec-title" style="font-size: 16px; margin-bottom: 10px;">Suggested Streams:</span>
                ...
                {{-- Career Options --}}
                <div class="rec-block" style="margin-bottom: 8px;">
                    <span class="rec-title" style="font-size: 16px; margin-bottom: 10px;">
                        @if(str_contains($test_name,'PROFESSIONAL'))
                    ...
                    <div class="rec-tags" style="line-height: 1.8;">
                        @foreach(explode(',', $outcome['career_options']) as $career)
                            <span class="tag" style="background-color: #e0f5f4; color: #018580; font-size: 14px; padding: 2px 5px;">{{ trim($career) }}</span>
                        @endforeach
                    </div>
                </div>
                ...
                {{-- Profile Decode --}}
                @if(!str_contains($test_name, 'PROFESSIONAL'))
                <div class="profile-decode" style="padding: 8px; margin-bottom: 8px;">
                    <span class="summary-title" style="font-size: 20px; margin-bottom: 3px; padding-bottom: 2px;">Profile Decode</span>
                    <div style="font-size: 14px; line-height: 1.5;font-style: italic;">"{{ $outcome['profile_decode'] }}"</div>
                </div>
                @endif
            </div>
        @endforeach
        ...
        @if(!empty($detailed_strengths)) 
            ...
            @foreach($detailed_strengths as $skill)
                @if($loop->index > 0 && $loop->index % 2 == 0)
                    <div class="page-break"></div>
                @endif
                <div class="summary-box" style="border-left-color: #27ae60; font-size: 14px; margin-top:40px">
