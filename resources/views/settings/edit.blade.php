        ...
        {{-- NAVIGATION TABS --}}
            <nav class="-mb-px flex space-x-8 overflow-x-auto pb-2" aria-label="Tabs">
                ...
                <a href="{{ route('profile.edit') }}" 
                   ...
                   {{ !request('tab') || request('tab') == 'profile' 
                        ? 'border-primary text-primary' 
                        : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                   
                   {{-- Icon: User --}}
                   <x-lucide-user class="mr-2 h-5 w-5 {{ !request('tab') || request('tab') == 'profile' ? 'text-primary' : 'text-black group-hover:text-primary' }}" />
                ...
                <a href="{{ route('profile.edit', ['tab' => 'password']) }}" 
                   ...
                   {{-- Icon: Lock (or Key) --}}
                   <x-lucide-lock class="mr-2 h-5 w-5 {{ request('tab') == 'password' ? 'text-primary' : 'text-black group-hover:text-primary' }}" />
