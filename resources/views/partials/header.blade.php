    ...
    >
        ...
        <nav class="w-full max-w-7xl mx-auto px-2 md:px-4">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden lg:flex items-center gap-6 lg:gap-8 font-semibold text-sm lg:text-base text-black">
                    ...
                    <a href="{{route('helplink')}}" class="{{ request()->routeIs('helplink') ? 'text-primary' : '' }} hover:text-primary active:text-primary transition-colors">Help Link</a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 py-4 space-y-2 flex flex-col font-medium text-black bg-white" @click="mobileMenuOpen = false">
                ...
                <a href="{{route('helplink')}}" class="block px-3 py-2 rounded-md {{ request()->routeIs('helplink') ? 'text-primary bg-primary/10' : '' }} hover:text-primary active:text-primary transition">Help Link</a>
