...
<div x-show="showInstructionModal" 
    ...
    <div x-show="showInstructionModal"
        ...
        <div class="bg-gray-50 px-6 py-4 flex gap-3 justify-end">
            <button @click="showInstructionModal = false;" class="px-6 py-2.5 rounded-lg bg-linear-to-r from-green-600 to-green-700 text-white font-semibold hover:from-green-700 hover:to-green-800 shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer">
                Start Test
            </button>
        </div>
    </div>
